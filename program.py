...
class Program:
    ...
    # 1. Central bank operations menu
    def handle_central_bank_operations(self) -> None:
        while True:
            ...
            if sub_menu_choice == "1. Populate database with new data":
                self.handle_populate_database_with_new_data()
            elif sub_menu_choice == "2. View database data":
                self.handle_view_database_data()
            elif sub_menu_choice == "3. Back to main menu":
                break

    # 1. Central bank operations -> 1. Populate database with new data
    def handle_populate_database_with_new_data(self) -> None:
        while True:
    ...
    # 1. Central bank operations -> 2. View database data
    def handle_view_database_data(self) -> None:
        while True:
        ...
        while True:
            ...
            if sub_menu_choice == "1. Validate identity":
                ...
                if not personal_code_exists(personal_code):
                    ...
                    continue
                # Only proceed if user enters valid personal code
                self.handle_validate_identity(personal_code)
            elif sub_menu_choice == "2. Back to main menu":
                break

    # 2. Personal bank operations -> 1. Validate identity
    def handle_validate_identity(self, personal_code) -> None:
